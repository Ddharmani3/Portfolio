        ...
        <div className='cont'>
            ...
            <NavHashLink smooth  exact to="#home"  className='logo'><img src="dlogo.png" height={"30px"} alt="logo" />  </NavHashLink>
             ...
             <ul className='social'>
                ...
                <li><div> <a className="resume" target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1X1mKFSg3mUZGsC13JVl-P53yizbkoGUk/view?usp=sharing"><Resume size="1.2rem" color="white" /> <h3>Resume</h3></a></div></li>
             </ul>
            </nav>
                </BrowserRouter>
        </div>
